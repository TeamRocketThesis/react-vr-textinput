...
class TextInput extends Component {
  ...
  handleBack() {
    if (this.state.displayArray[0][0] !== '|') {
      ...
      if (cp === 0) {
        ...
        arr[index] = `${arr[index].slice(0, cp - 1)}|${arr[index][cp - 1]}${arr[index].slice(
          cp + 1,
        )}`;
      }
  ...
  render() {
    ...
    return (
      <View
        style={{
          transform: [{ rotateY: this.props.rotateY || 0 }, { rotateX: this.props.rotateX || 0 }],
        }}
      >
        <View>
        ...
        <View
          style={{
            transform: [{ translate: [this.state.x + 1, this.state.y + 0.3, this.state.z] }],
          }}
        >
          <Scroll
        ...
        {this.state.focus ? (
          <View
            style={{
              transform: [
                { translate: [this.state.x - 0.2, this.state.y, this.state.z] },
                { rotateX: -30 },
              ],
            }}
          >
